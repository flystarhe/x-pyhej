...
from pyssr.datasets.reconstruct import Reconstruct
from torch.utils.data.distributed import DistributedSampler
from torch.utils.data.sampler import RandomSampler


# Supported datasets
_DATASETS = {"abnormal": Abnormal, "denoising": Denoising, "reconstruct": Reconstruct}

# Default data directory (pyssr/datasets/data)
_DATA_DIR = os.path.join(os.path.dirname(__file__), "data")

# Relative data paths to default data directory
_PATHS = {"abnormal": "abnormal", "denoising": "abnormal", "reconstruct": "abnormal"}
